...
class TableTestCaseExample(tabletest.TableTestCase):
...
class TableTestCaseExampleTwoTables(tabletest.TableTestCase):
    """An example table test case, with two table tests."""
    TEST_CASES_1 = ['A', 'B', 'C']
    SEEN_1 = set()

    @tabletest.tabletest(TEST_CASES_1)
    ...
    @tabletest.tabletest(TEST_CASES_2)
    def test_second(self, test_case):
        TableTestCaseExampleTwoTables.SEEN_2.add(int(test_case))


class TableTestCaseExampleExtra(tabletest.TableTestCase):
